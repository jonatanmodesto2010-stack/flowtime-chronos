          ...
          <div className="flex gap-6">
            ...
            <motion.div initial={{
              ...
              {filteredClients.length === 0 ? <div className="text-center py-20 text-muted-foreground">
                  ...
                  delay: index * 0.05
                }} className={`w-full rounded-lg p-4 flex items-center gap-4 transition-colors ${!client.is_active ? 'bg-red-500/10 hover:bg-red-500/15 border border-red-500/30' : isCompleted(client.status) ? 'bg-muted/50 hover:bg-muted/60 opacity-70 grayscale' : 'bg-card hover:bg-card/80'}`}>
